 ...
 * For ExpListTest.
 */
public abstract class RecyclerViewOnScrollListenerRate extends OnScrollListener
{
    private static final int DEFAULT_NUM_OF_ARTICLE_OF_PAGE = 20;
//    private  static final String LOG = RecyclerViewOnScrollListener.class.getSimpleName();
    ...
    public RecyclerViewOnScrollListenerRate()
    {
