...
import ru.dante.scpfoundation.utils.RecyclerViewOnScrollListenerRate;
import ru.dante.scpfoundation.utils.ScreenProperties;
import ru.dante.scpfoundation.utils.parsing.DownloadNewArticles;
import ru.dante.scpfoundation.utils.parsing.DownloadRateArticles;

/**
 * Created by Dante on 16.01.2016.
 */
public class FragmentRateArticles extends Fragment implements DownloadNewArticles.UpdateArticlesList, SharedPreferences.OnSharedPreferenceChangeListener
{
    public static final String LOG = FragmentRateArticles.class.getSimpleName();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
    {
        ...
        swipeRefreshLayout.setOnRefreshListener(new SwipeRefreshLayout.OnRefreshListener()
        {
            ...
            public void onRefresh()
            {
                ...
                DownloadRateArticles downloadNewArticles = new DownloadRateArticles(currentPageToLoad, FragmentRateArticles.this, ctx);
...
//        resetOnScrollListener();
        ...
        if (listArticles.size() == 0)
        {
            ...
            DownloadRateArticles downloadNewArticles = new DownloadRateArticles(currentPageToLoad, this, ctx);
            downloadNewArticles.execute();
            setLoading(true);
        } else
        {
    ...
    private void resetOnScrollListener()
    {
        ...
        recyclerView.addOnScrollListener(new RecyclerViewOnScrollListenerRate()
        {
            @Override
